angular.module("rest-client").run([
    "$templateCache",
    function($templateCache) {
        "use strict";

        $templateCache.put(
            "./modules/404/404.html",
        ...
        $templateCache.put(
            "./modules/errorTypes/errorTypes.html",
        ...
        $templateCache.put(
            "./modules/reports/report/index.html",
