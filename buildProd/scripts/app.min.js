...
/localhost/.test(hostname)
    ...
    : /plv2\-qual\.nr(?:co|)\.fr/.test(hostname)
        ? (keycloakJson.url = protocol + "//auth-qual.nrco.fr/auth")
        : /plv2\.nr(?:co|)\.fr/.test(hostname) &&
    ...
    angular
        .module("rest-client")
        .constant("globals", {
            plApi: { baseUrl: "/api/v1/error-manager" },
            debug: !0,
            debugRouter: !1,
            sampleData: !0
        }),
    ...
    angular.module("rest-client").controller("RootController", [
        "$rootScope",
        function(a) {
            (this.logo = { miniText: "test", img: "statics/img/icon.png" }),
                (this.user = { username: "Theo Guerin", logout: "/logout" }),
                (this.menu = a.menu),
    ...
    angular.module("rest-client").config([
        ...
        "menuProvider",
        function(a, b) {
            a.state("rest-client.error-types", {
    ...
    angular.module("rest-client").controller("errorTypesController", [
        ...
        "toaster",
        function(a, b, c, d, e) {
            (a.errorType = { throwError: !0 }),
                (a.errorTypes = b),
                (this.addType = function(b) {
                    var d,
                        f = angular.isUndefined(b._id);
                    (d = f ? c.post(b) : c.put(b)),
                        d
                            .then(function(c) {
                                f
                                    ? (a.errorTypes.unshift(b),
                                      (a.errorType = {}))
                                    : (b = c),
                                    e.success(
                                        "Sauvegarde réussie",
                            ...
                            .catch(function(a) {
                                throw (e.error("Erreur", a), a);
                            });
                }),
                (this.deleteType = function(b) {
                    d
                        .confirmDelete({
                            title: "Supression",
                            text:
                        ...
                        .then(function() {
                            a.errorTypes.splice(a.errorTypes.indexOf(b), 1);
                        })
                        .catch(function(a) {
                            if (!0 !== a) throw (e.error("Erreur", a), a);
                        });
                });
        }
    ]),
        ...
        function(a, b, c) {
            ...
            (a.logs = b),
                ...
                (this.getMoreLogs = function() {
                    (d.limitSize += d.defaultLimitSize), d.refreshLogs();
                });
        }
    ]),
    angular.module("rest-client").config([
    ...
    angular.module("rest-client").config([
        ...
        "menuProvider",
        function(a, b, c) {
            a.state("rest-client.reports.report", {
                entryName: [
                    "report",
                    function(a) {
                        return "Rapport " + a._id;
                    }
                ],
                url: "/:id",
                ...
                resolve: {
                    report: [
                        ...
                        "$stateParams",
                        function(a, b) {
                            return console.log(b), a.getById({ _id: b.id });
                        }
                    ],
                    logs: [
                        "logService",
                        ...
                        function(a, b) {
                            ...
                            return a.get(null, {
                                ...
                                filter: JSON.stringify({
                                    "data.date": {
                                        $gte: new Date(c.getTime() - 6e4),
                                        $lte: new Date(c.getTime() + 6e4)
                                    }
                                })
                            });
                        }
    ...
    angular.module("rest-client").controller("reportController", [
        ...
        "reportService",
        function(a, b, c, d, e) {
            console.log(c), (a.logs = c), (a.report = b);
        }
    ]),
    angular.module("rest-client").service("errorTypeService", [
        "appResourceProxy",
        function(a) {
            return a("/error-types");
        }
    ]),
